...
#rm /tmp/{instance,scenario,parcelp,objval,nveh,ttime, tpass, tpar, tboth, tnone, tstill}
...
paste /tmp/instance /tmp/scenario /tmp/parcelp /tmp/objval /tmp/nveh /tmp/ttime /tmp/sstat /tmp/tpass /tmp/tpar /tmp/tboth /tmp/tnone /tmp/tstill> Statsthybbundle18-301A.txt
