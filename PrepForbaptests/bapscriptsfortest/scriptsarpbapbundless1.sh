...
dirSol='sol_test/sol_sfsarp1'
output='bapbundletest0sfsarp.txt'
#runs=10
...
#			echo "Scenario: 1A bundle "  >> $output
			./bin/sharearidec -b config/CVRPbc.cfg -a config/CVRPapp.cfg -i ${dirInstancias}/${arquivo} --cutOffValue $(cat ${dirSol}/${arquivo}) --useBundleRCSP=true >> $output
