...
dirInstancias='O-C3/sf_data'
output='testsfsarpbundle1.txt'
#runs=10
...
#			./exeSARP ${dirInstancias}/${arquivo} 1A fip >> $output
			./bin/bin.out ${dirInstancias}/${arquivo} 2MM bundle2 >> $output
			./bin/bin.out ${dirInstancias}/${arquivo} 2MM bundle4 >> $output
		done
#	done
#done
