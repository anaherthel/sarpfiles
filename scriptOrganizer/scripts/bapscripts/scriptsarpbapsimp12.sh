...
dirInstancias='data/grubhub'
dirSol='sol_ghsarp'
output='bapscspghsarpimp.txt'
#runs=10
...
#			echo "Scenario: 1A bundle "  >> $output
			./bin/sharearidec -b config/CVRPbc.cfg -a config/CVRPapp.cfg -i ${dirInstancias}/${arquivo} --cutOffValue $(cat ${dirSol}/${arquivo}) --scenario=0 --improved=0 >> $output
